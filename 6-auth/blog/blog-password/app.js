...
everyauth.twitter
  ...
  .findOrCreateUser(function(session, accessToken, accesTokenSecret, twitterUserMetaData){
    var promise = this.Promise()
    process.nextTick(function () {
      if (twitterUserMetaData.screen_name === 'awaiszahid968') {
...
everyauth.everymodule.logoutPath(routes.user.logout)
